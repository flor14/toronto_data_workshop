...
```{r ej1, echo = FALSE, out.width=600}
...
## Three examples of information to include in the `README` in relation with the method you are using to capture the environment
