...
```{r cultural_shift, echo = FALSE, out.width=400, fig.align='center'}
...
.pull-right[
```{r rc3, echo = FALSE, out.width=500}
...
```{r rc4, echo = FALSE, out.width=500, fig.align='center'}
...
**Write a reproducibility ROADMAP**
...
## Three examples of what to include in the **readme**
...
```{r sessioninfo, echo = FALSE, out.width=700, fig.align='center'}
...
```{r docker, echo = FALSE, out.width=700, fig.align='center'}
...
[Example](https://github.com/jupyter/jupyter/wiki/A-gallery-of-interesting-Jupyter-Notebooks#reproducible-academic-publications)
...
```{r notfound, echo = FALSE, out.width=500, fig.align='center'}
...
## What I have learned in **ReproHack**?
...
#### - **Researchers develops software** for their scientific articles (even if their are not aware of it)
...
* [Guide to writing "readme" style metadata - RESEARCH DATA MANAGEMENT SERVICE GROUP - Cornell University](https://data.research.cornell.edu/content/readme) 
