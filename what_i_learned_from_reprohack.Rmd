...
.footnote[[The Turing Way: A Handbook for Reproducible Data Science (2019)](https://the-turing-way.netlify.app/) | [The Turing Way Community, & Scriberia. (2020)](http://doi.org/10.5281/zenodo.3695300)]
...
```
.footnote[[Codecheck](https://codecheck.org.uk/)]
 ]
...
kableExtra::kbl(data.frame(Category = c("What", "Why", "How", "When", "Who", "References", "Contribution", "Other"),
   ...
   kable_minimal() %>% 
   kable_styling() %>% 
  row_spec(3, bold = T, color = "white", background = "#6a0dad") 


# knitr::include_graphics("imagenes/categorizing_readmes.png")
```

.footnote[[Table extracted from Prana *et al.* (2019)](https://link.springer.com/article/10.1007/s10664-018-9660-3#citeas)]
...
.footnote[[README template `rrtools` package](https://github.com/benmarwick/rrtools)]
...
.footnote[[Publishing reproducible logbooks](https://opendreamkit.org/2017/11/02/use-case-publishing-reproducible-notebooks/)]
---
...
Are you writing the documentation for you or for someone that doesn't know the technology you are using?
...
```{r latinr, echo = FALSE, out.width=600, fig.align='center'}
knitr::include_graphics("imagenes/latinr.png")
```
